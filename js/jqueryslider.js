;(function($){
	$.fn.ZHYslider = function(options){
			...
			fn={
				...
				_slide:function(){
							...
							switch(settings.affect)
								...
								break;
								case 'fade_animate':
									settings.animate ? settings.animate_star($contents.eq(index)) : false; 
									
									$contents.eq(last_index).stop(true,false).animate({'opacity': 0}, settings.speed/2).css('z-index',1)
											 .end()
											 .eq(index).css('z-index',9).stop().animate({'opacity': 1}, settings.speed/2,function(){
		...
		var html			= '',
			...
			if(settings.affect == 'fade' ||settings.affect == 'fade_animate'  )
			{
			...
			settings.animate ? settings.animate_star($contents.eq(0)) : false; 
